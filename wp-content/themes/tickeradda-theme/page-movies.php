        ...
        <div class="container">
            ...
            <div class="movies-page-container">
                ...
                <aside class="movies-sidebar">
                    ...
                    <div class="filter-group">
                        <h4>Rating</h4>
                        <label class="filter-label"><input type="checkbox" class="rating-filter" value="9"> 9+ Rating</label>
                        <label class="filter-label"><input type="checkbox" class="rating-filter" value="8"> 8+ Rating</label>
                        <label class="filter-label"><input type="checkbox" class="rating-filter" value="7"> 7+ Rating</label>
                    </div>
