...
bloginfo('name'); ?>
    ...
    <link rel="icon" type="image/png"
        href="<?php echo esc_url(get_template_directory_uri() . '/public/images/favicon.png'); ?>">
    <?php wp_head(); ?>
    <script>
        ...
        <nav class="navbar">
            <div class="container nav-content">
                <a href="<?php echo esc_url(home_url('/')); ?>" class="logo">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/public/images/logo.png'); ?>"
                        alt="TickerAdda">
                </a>
                ...
                <div class="nav-links" id="navLinks">
                    ...
                    <a href="<?php echo esc_url(home_url('/seller-dashboard/')); ?>" class="nav-link"
                        id="dashboardLink"
                        style="<?php echo is_user_logged_in() ? 'display: inline-block;' : 'display: none;'; ?>">My
                        Listings</a>
                    <a href="<?php echo esc_url(home_url('/buyer-dashboard-2/')); ?>" class="nav-link"
                        id="myTicketsLink"
                        style="<?php echo is_user_logged_in() ? 'display: inline-block;' : 'display: none;'; ?>">My
                        Requests</a>
                    <a href="<?php echo esc_url(home_url('/calculator/')); ?>" class="nav-link">Calculator</a>
                    <a href="<?php echo esc_url(home_url('/seller-dashboard/')); ?>" class="btn btn-primary"
...
?>
                    <div id="userBadge" class="user-header-group"
                        style="display: flex; align-items: center; gap: 10px; margin-left: 10px;">
                        <a href="<?php echo esc_url(home_url('/seller-dashboard/')); ?>" class="btn btn-outline"
                            style="display: flex; align-items: center; gap: 8px;">
                            <div
                                style="width: 24px; height: 24px; background: var(--primary); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 12px; font-weight: 700; color: white;">
                        ...
                        <a href="#" class="btn-logout" onclick="logout(); return false;"
                            style="color: #ef4444; font-size: 0.9rem; text-decoration: none; padding: 5px 10px; border-radius: 6px; background: rgba(239, 68, 68, 0.1); border: 1px solid rgba(239, 68, 68, 0.2); transition: all 0.2s;">
                            <i class="fas fa-sign-out-alt"></i>
                        </a>
                    </div>
                    <?php
else: ?>
                    <a href="<?php echo esc_url(home_url('/login/')); ?>" class="btn btn-outline" id="loginBtn"
    ...
    <div class="loader-container" id="global-loader"
        ...
        <div class="loader"
            style="border: 4px solid #f3f3f3; border-top: 4px solid var(--primary); border-radius: 50%; width: 40px; height: 40px; animation: spin 1s linear infinite;">
        </div>
    </div>
    <style>
        @keyframes spin {
